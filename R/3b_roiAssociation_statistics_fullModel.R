...
png(file.path(outdir,'roi_assoc_res_two_methods_fullModel.png'),
...
pdf(file.path(outdir,"forest_plot_assoc_WMH_roi_ctxTH_fullModel.pdf"),
    width=6,height=6.5)
print(p)
dev.off()
