...
##*****************************************************************************#
op <- options(warn=1)
scale.limits = c(-0.169,  0.136)
scale.limits = range(c(scale.limits,-scale.limits))

# start the looping over subsets ----------------------------------------------
for(filter_group in filter_groups){#***REMOVE '[1]' BEFORE DISTRIBUTION
