...
if(file.exists(file.path(outdir,"smooth_plots_adjfull_age_lt_65"))){
  unlink(file.path(outdir,"smooth_plots_adjfull_age_lt_65"),recursive = T)
}

dir.create(file.path(outdir,"smooth_plots_adjfull_age_lt_65"))
for (roi in rois){
  if(roi!="cuneus"){
  ...
  pfile = file.path(outdir,'smooth_plots_adjfull_age_lt_65',paste("sm_plot_adjfull_",roi,"%03d_age_lt_65.png",sep=""))
...
adj_ctx_full_age_lt_65 = adj_ctx
adj_BMI_full_age_lt_65 = adj_BMI
